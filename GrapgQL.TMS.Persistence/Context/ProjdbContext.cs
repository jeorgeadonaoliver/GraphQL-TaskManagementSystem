...
namespace GraphQL.TMS.Persistence.Context;
...
//        => optionsBuilder.UseSqlServer("Server=JEORGEOLIVER-LA\\SQLEXPRESS;Database=PROJDB;Trusted_Connection=True;Integrated Security=True;TrustServerCertificate=True");
